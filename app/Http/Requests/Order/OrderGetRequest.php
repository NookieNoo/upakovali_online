...
class OrderGetRequest extends JsonRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'receiving_date_from' => 'date|date_format:Y-m-d',
            'receiving_date_to' => 'date|date_format:Y-m-d',
            'issue_date_from' => 'date|date_format:Y-m-d',
            'issue_date_to' => 'date|date_format:Y-m-d',
