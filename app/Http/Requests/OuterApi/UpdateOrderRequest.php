...
class UpdateOrderRequest extends JsonRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return [
            ...
            'gifts.*.id' => 'int|min:1|exists:gifts,id',
    ...
    public function getDto(): OrderUpdateByApiDto
    {
        return new OrderUpdateByApiDto($this->validated());
    }
}
